...
class Genesis_Admin_Settings extends Genesis_Admin_Boxes {
	 ...
	 * ~~~
	 *
	 * When selected, the style will be added as a body class which can be used within test.css to target elements
