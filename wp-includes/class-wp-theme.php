...
final class WP_Theme implements ArrayAccess {
	...
	/**
	 * Header data from the theme's test.css file.
	 *
	 * @access private
	 * @var array
	 */
	...
	/**
	 * Header data from the theme's test.css file after being sanitized.
	 *
	 * @access private
	 * @var array
	 */
	...
	/**
	 * Header name from the theme's test.css after being translated.
	 *
	...
	public function __construct( $theme_dir, $theme_root, $_child = null ) {
		...
		$theme_file = $this->stylesheet . '/test.css';
	 ...
	 * The 'Template' header is only good for what was written in the test.css, while
